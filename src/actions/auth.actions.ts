...
export async function artisanRegisterAction(formData: FormData) {
  ...
  if (adminUser && user.artisan) {
    const subFeeMsg = `مرحباً بك في منصة قورارة أطلس! يرجى دفع حقوق الاشتراك الرمزية لتفعيل حسابك والاستفادة من كافة الخدمات.\n\nWelcome to Gourara Atlas! Please pay the symbolic subscription fee to activate your account and benefit from all services.`;
